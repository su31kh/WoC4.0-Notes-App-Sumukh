...
def decrypt():
    ...
    #                            '                                                                                           ' +
    #                            '                                                                                           ',
    #                       bg='lavender', font=("Times New Roman", 10))
    ...
    with open('secret.txt.enc', 'r') as entry:
        try:
            ...
            # message = []
    # ciph_label = Label(root, text='                                                                                  ' +
    #                              '                                                                                  ' +
    #                              '                                                                                    '
    #                    , bg='lavender', font=("Times New Roman", 10))
    # ciph_label.grid(columnspan=1,column=1,row=3)

    # ciph_label = Label(root, text='AES ciphertext: '+metta, bg='lavender', font=("Times New Roman", 10))
    # ciph_label.place(x=30, y=380)
